...
from ray_diffusion.inference.predict import predict_cameras_for_rec, predict_cameras_for_rec_6dof_output
import os
import pickle
...
seqs = ['08']
# Model directory
model_vo_diffusion_results_directory = "/hdd2/fanqi/ckps/checkpoints_for_rec/inverse_forward_regression_scratch_dinov2_dit16_6dof_output/output/0220_170508_111841" 
...
if seqs == ['09']:
    ...
    logger_08_all = ResultsLogger('{}/08_all.csv'.format(model_vo_diffusion_inference_ate_rpe_csv))
    ...
    for seq in seqs:
        ...
        with torch.no_grad():
            for counter, idx in enumerate(instances):
                ...
                pred= predict_cameras_for_rec_6dof_output(
                            model_vo_diffusion,
                            images,
                            device,
                            pred_x0=True,
                ...
                vo_inverse_lie_alg.append(pred[0][0].cpu())
                vo_forward_lie_alg.append(pred[0][1].cpu())
                # break
            ...
            if seq == '09':
                ...
                logger_08_all.log(seq, epoch_num,'RT_from_known_intrinsic', errors_inv_lie_alg[0], errors_inv_lie_alg[1], errors_inv_lie_alg[2], errors_inv_lie_alg[3], errors_fwd_lie_alg[0], errors_fwd_lie_alg[1], errors_fwd_lie_alg[2], errors_fwd_lie_alg[3], errors_fwd_inv_lie_alg[0], errors_fwd_inv_lie_alg[1], errors_fwd_inv_lie_alg[2], errors_fwd_inv_lie_alg[3])
            ### new
