...
TRAINING_CATEGORIES =['2014-11-18-13-20-12', '2015-07-08-13-37-17', '2015-07-10-10-01-59', '2015-08-12-15-04-18']
# whole
# ['2015-02-24-12-32-19'] ['2015-03-24-13-47-33'] ['2015-08-12-15-04-18']
# ['2014-11-18-13-20-12', '2015-02-17-14-42-12', '2015-02-24-12-32-19', '2015-03-03-11-31-36', '2015-03-24-13-47-33', '2015-04-17-09-06-25', '2015-04-24-08-15-07', '2015-04-28-15-52-02', '2015-07-08-13-37-17', '2015-07-10-10-01-59', '2015-07-29-13-09-26', '2015-08-12-15-04-18', '2015-08-17-10-42-18', '2015-08-28-09-50-22', '2015-11-12-11-22-05']

# ['00', '01', '02','03', '04', '05', '06', '07', '08','09','10']
# ['00', '01', '02','03', '04', '05', '06', '07', '08'] # ['00', '01', '02', '04', '05', '06', '07', '08']
TEST_CATEGORIES = ['10']

print("oxford robotcar using inverse and forward odometry")
    ...
    def __init__(
        ...
        for c in self.category:
            ...
            for i in range(annotation['cam_02'].shape[0]-1):
                ...
                if not is_valid_transformation_matrix(relative_pose):
                    all_valid = False
                    print(f"Invalid relative pose for {c} sequence {i}.")
