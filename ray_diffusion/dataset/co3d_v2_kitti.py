...
TRAINING_CATEGORIES = ['00', '01', '02','03', '04', '05', '06', '07', '08','09','10']
        ...
        if self.transform is None:
            self.transform = transforms.Compose(
                [
                    ...
                    transforms.Resize((182,630), antialias=True), 
    ...
    def get_data(self, index=None, sequence_name=None, ids=(0, 1), no_images=False):
        ...
        for anno in annos:
            ...
            if not no_images:
                ...
                # print("image.size",image.size) # 640,192
                ...
                bbox_init = [0, 0, 640, 192] #([100, 0, image.width - 150, image.height]) # [0, 0, 640, 192]
                ...
                # plt.imsave(f'output_3kitti_transform_image_{count}.png', image_np)
                # print("image.shape",image.shape) # torch.Size([3, 224, 224])
                # imagepil = transforms.ToPILImage()(image)
                # imagepil.save(f'rec_output_3kitti_transform_image_{count}.png')
                # image = image[:rec_, : self.img_size, : self.img_size]
                # imagepil = transforms.ToPILImage()(image)
